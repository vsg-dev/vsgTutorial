...
position[1] = 2.0; // equivilant to position.y = 2.0

vsg::vec3 normal(0.0f, 0.0f, 1.0f); // floating point vec3
normal.set(0.0f, 1.0, 0.0f);

// colours
vsg::vec4 color(1.0, 0.0, 0.0, 1.0); // float vec4 representing opqaue red
color.r *= 0.5; // half the red intensity
color[3] = 1.0; // set the b channel to 1.0
